...
require (
	github.com/AustralianCyberSecurityCentre/azul-bedrock/v12 v12.0.65
...
// replace github.com/AustralianCyberSecurityCentre/azul-bedrock/v12 v12.0.65 => ../azul-bedrock
