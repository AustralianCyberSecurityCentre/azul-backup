...
require (
	github.com/AustralianCyberSecurityCentre/azul-bedrock/v12 v12.0.101
...
// replace github.com/AustralianCyberSecurityCentre/azul-bedrock/v12 v12.0.67 => ../azul-bedrock
